...
const Weather = props => (
  <div className="weather__info">
    ...
    {props.temperature && (
      <p className='weather__key'>
        Temperature: 
        <span className='weather__value'> {Math.round(9 / 5 * (props.temperature - 273) + 32)}&deg;F</span>
      </p>
    )}
    ...
    {props.max_temp && (
      <p className='weather__key'>
        Maximum Temp:
        <span className='weather__value'> {Math.round(9 / 5 * (props.max_temp - 273) + 32)}&deg;F </span>
      </p>
    )}
